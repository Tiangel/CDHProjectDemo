...
public class HttpClientUtil {
    ...
    public static void downloadGZFile(String url, String fileName) {
        ...
        try {
            if (!file.exists()) {
                ...
                InputStreamReader inputStreamReader = new InputStreamReader(gzipInputStream, CHARSET_NAME);
                bufferedReader = new BufferedReader(inputStreamReader);
                bufferedWriter = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(file), CHARSET_NAME));
                String line = null;
